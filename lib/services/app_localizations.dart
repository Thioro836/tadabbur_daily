class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'fr': {
      ...
      'exportDataDesc': 'Enregistre un PDF de vos notes et réflexions',
      'exportedToClipboard': '✅ Export PDF prêt à partager !',
      'view': 'Visualiser',
      'edit': 'Modifier',
    ...
    'en': {
      ...
      'exportDataDesc': 'Save a PDF of your notes and reflections',
      'exportedToClipboard': '✅ PDF export ready to share!',
      'view': 'View',
      'edit': 'Edit',
